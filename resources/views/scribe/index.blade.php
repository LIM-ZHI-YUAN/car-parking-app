                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-POSTapi-v1-auth-login">POST api/v1/auth/login</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="auth-GETapi-v1-profile">
                                <a href="#auth-GETapi-v1-profile">GET api/v1/profile</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-PUTapi-v1-profile">
                                <a href="#auth-PUTapi-v1-profile">PUT api/v1/profile</a>
                            </li>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="auth-GETapi-v1-profile">GET api/v1/profile</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="auth-PUTapi-v1-profile">PUT api/v1/profile</h2>
...
<form id="form-POSTapi-v1-parkings-start" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-parkings-start');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-parkings-start"
                    onclick="cancelTryOut('POSTapi-v1-parkings-start');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the zones table. Example: <code>17</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/parkings/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/parkings/17"
);
...
<form id="form-GETapi-v1-parkings--parking_id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-parkings--parking_id-"
                    onclick="tryItOut('GETapi-v1-parkings--parking_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-parkings--parking_id-"
                    onclick="cancelTryOut('GETapi-v1-parkings--parking_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-parkings--parking_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="parking_id"                data-endpoint="GETapi-v1-parkings--parking_id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the parking. Example: <code>17</code></p>
            </div>
                    </form>
...
<form id="form-PUTapi-v1-parkings--parking_id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-parkings--parking_id-"
                    onclick="tryItOut('PUTapi-v1-parkings--parking_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-parkings--parking_id-"
                    onclick="cancelTryOut('PUTapi-v1-parkings--parking_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-parkings--parking_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="parking_id"                data-endpoint="PUTapi-v1-parkings--parking_id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the parking. Example: <code>17</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/vehicles/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/vehicles/17"
);
